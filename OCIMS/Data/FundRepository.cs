...
namespace OCIMS.Data
{
    public class FundRepository
    {
        ...
        public bool Save(FundSource f)
        {
            ...
            {
                System.Windows.MessageBox.Show("Error saving fund: " + ex.Message, "OCIMS",
                    System.Windows.MessageBoxButton.OK, System.Windows.MessageBoxImage.Error);
                return false;
            }
        }
        ...
        public bool Update(FundSource f)
        {
            ...
            {
                System.Windows.MessageBox.Show("Error updating fund: " + ex.Message, "OCIMS",
                    System.Windows.MessageBoxButton.OK, System.Windows.MessageBoxImage.Error);
                return false;
            }
        }
        ...
        public bool Delete(int fundId)
        {
            ...
            {
                System.Windows.MessageBox.Show("Error deleting fund: " + ex.Message, "OCIMS",
                    System.Windows.MessageBoxButton.OK, System.Windows.MessageBoxImage.Error);
                return false;
            }
        }
